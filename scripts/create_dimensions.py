...
def main():
    """
    Create cloud-only dim_locations from RDS source tables.
    """
    print("Starting dimension creation process...")
    ...
    try:
        ...
        with engine.begin() as conn:
            ...
            print("dim_locations created successfully.")

    except Exception as e:
        print(f"An error occurred in create_dimensions: {e}")
        raise
